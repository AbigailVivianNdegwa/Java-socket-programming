...
5. Do the same thing for all the Client windows.
6. You will be prompted to add user names and once added, it will reflect on the server that a user has connected.
7. The server will then broadcast the messages to all the clients except the one sending the message.
